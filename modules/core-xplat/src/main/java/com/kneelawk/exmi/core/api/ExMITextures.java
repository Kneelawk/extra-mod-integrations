...
public class ExMITextures {
    public static final ResourceLocation SIMPLIFIED_ICONS = rl("textures/gui/simplified_icons.png");
    public static final ResourceLocation WIDGETS = rl("textures/gui/widgets.png");
    ...
    public static final EmiTexture CONDENSING = new EmiTexture(SIMPLIFIED_ICONS, 96, 16, 16, 16);
    ...
    public static final EmiTexture DOWN_ARROW = new EmiTexture(WIDGETS, 208, 240, 16, 16);
}
