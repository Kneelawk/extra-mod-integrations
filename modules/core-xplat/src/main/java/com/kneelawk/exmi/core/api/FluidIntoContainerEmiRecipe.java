...
public class FluidIntoContainerEmiRecipe implements EmiRecipe {
    ...
    public FluidIntoContainerEmiRecipe(ResourceLocation id, EmiStack fluid, EmiStack container,
                                       EmiStack emptyContainer) {
        this.id = id;
        this.fluid = fluid;
    ...
    public EmiRecipeCategory getCategory() {
        return ExMI.FLUID_INTO_CONTAINER_CATEGORY;
    }
