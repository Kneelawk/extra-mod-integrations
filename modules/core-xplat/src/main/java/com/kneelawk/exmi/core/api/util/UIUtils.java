...
import static com.kneelawk.exmi.core.api.ExMIConstants.gui;
...
public class UIUtils {
    ...
    public static void cookArrow(WidgetHolder widgets, int ticks, int x, int y) {
        widgets.addFillingArrow(x, y, ticks * 50)
            .tooltip((x1, y1) -> List.of(ClientTooltipComponent.create(cookTime(ticks))));
    }
    ...
    public static void renderFluid(PoseStack matrices, TextureAtlasSprite[] sprites, int color, int x, int areaY,
