...
public class FluidGeneratorEmiRecipe implements EmiRecipe {
    ...
    public FluidGeneratorEmiRecipe(RecipeHolder<FluidGeneratorRecipe> recipe, EmiRecipeCategory category,
        ...
        height = Mth.clamp(recipe.value().power() * 48 / energyCapacity, 0, 48);
    }
    ...
    public void addWidgets(WidgetHolder widgets) {
        ...
        widgets.addTexture(TRTextures.ENERGY_BAR_EMPTY, 22 + 24, 3).tooltip((mx, my) -> List.of(
            ClientTooltipComponent.create(
                tooltip("recipe_power_per_bucket", recipe.power()).getVisualOrderText())));
