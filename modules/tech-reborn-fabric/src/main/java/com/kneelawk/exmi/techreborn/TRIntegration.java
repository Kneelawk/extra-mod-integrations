...
public class TRIntegration implements ExMIPlugin {
    ...
    public void register(EmiRegistry registry) {
        ...
        for (var recipe : registry.getRecipeManager().getAllRecipesFor(ModRecipes.ALLOY_SMELTER)) {
        ...
        for (var recipe : registry.getRecipeManager().getAllRecipesFor(ModRecipes.ASSEMBLING_MACHINE)) {
        ...
        for (var recipe : registry.getRecipeManager().getAllRecipesFor(ModRecipes.BLAST_FURNACE)) {
        ...
        for (var recipe : registry.getRecipeManager().getAllRecipesFor(ModRecipes.CENTRIFUGE)) {
        ...
        for (var recipe : registry.getRecipeManager().getAllRecipesFor(ModRecipes.CHEMICAL_REACTOR)) {
        ...
        for (var recipe : registry.getRecipeManager().getAllRecipesFor(ModRecipes.COMPRESSOR)) {
        ...
        for (var recipe : registry.getRecipeManager().getAllRecipesFor(ModRecipes.DISTILLATION_TOWER)) {
        ...
        for (var recipe : registry.getRecipeManager().getAllRecipesFor(ModRecipes.EXTRACTOR)) {
        ...
        for (var recipe : registry.getRecipeManager().getAllRecipesFor(ModRecipes.GRINDER)) {
        ...
        for (var recipe : registry.getRecipeManager().getAllRecipesFor(ModRecipes.IMPLOSION_COMPRESSOR)) {
        ...
        for (var recipe : registry.getRecipeManager().getAllRecipesFor(ModRecipes.INDUSTRIAL_ELECTROLYZER)) {
        ...
        for (var recipe : registry.getRecipeManager().getAllRecipesFor(ModRecipes.INDUSTRIAL_GRINDER)) {
        ...
        for (var recipe : registry.getRecipeManager().getAllRecipesFor(ModRecipes.INDUSTRIAL_SAWMILL)) {
        ...
        for (var recipe : registry.getRecipeManager().getAllRecipesFor(ModRecipes.SCRAPBOX)) {
        ...
        for (var recipe : registry.getRecipeManager().getAllRecipesFor(ModRecipes.VACUUM_FREEZER)) {
        ...
        for (var recipe : registry.getRecipeManager().getAllRecipesFor(ModRecipes.FLUID_REPLICATOR)) {
        ...
        for (var recipe : registry.getRecipeManager().getAllRecipesFor(ModRecipes.FUSION_REACTOR)) {
        ...
        for (var recipe : registry.getRecipeManager().getAllRecipesFor(ModRecipes.ROLLING_MACHINE)) {
        ...
        for (var recipe : registry.getRecipeManager().getAllRecipesFor(ModRecipes.SOLID_CANNING_MACHINE)) {
        ...
        for (var recipe : registry.getRecipeManager().getAllRecipesFor(ModRecipes.WIRE_MILL)) {
        ...
        for (var recipe : registry.getRecipeManager().getAllRecipesFor(ModRecipes.THERMAL_GENERATOR)) {
        ...
        for (var recipe : registry.getRecipeManager().getAllRecipesFor(ModRecipes.GAS_GENERATOR)) {
        ...
        for (var recipe : registry.getRecipeManager().getAllRecipesFor(ModRecipes.DIESEL_GENERATOR)) {
        ...
        for (var recipe : registry.getRecipeManager().getAllRecipesFor(ModRecipes.SEMI_FLUID_GENERATOR)) {
        ...
        for (var recipe : registry.getRecipeManager().getAllRecipesFor(ModRecipes.PLASMA_GENERATOR)) {
        ...
        for (ResourceLocation fluidId : BuiltInRegistries.FLUID.keySet()) {
            ...
            ResourceLocation fromId =
                ResourceLocation.fromNamespaceAndPath(ExMI.FLUID_FROM_CONTAINER_CATEGORY.id.getNamespace(),
                    "/" + ExMI.FLUID_FROM_CONTAINER_CATEGORY.id.getPath() + "/" + cellId.getNamespace() + "/" +
            ...
            ResourceLocation intoId =
                ResourceLocation.fromNamespaceAndPath(ExMI.FLUID_INTO_CONTAINER_CATEGORY.id.getNamespace(),
                    "/" + ExMI.FLUID_INTO_CONTAINER_CATEGORY.id.getPath() + "/" + cellId.getNamespace() + "/" +
                        cellId.getNamespace() + "/" + fluidId.getNamespace() + "/" + fluidId.getPath());
    ...
    public static ResourceLocation trId(String path) {
        return ResourceLocation.fromNamespaceAndPath("techreborn", path);
    }
}
