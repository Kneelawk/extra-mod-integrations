...
import com.kneelawk.exmi.farmersdelight.FDRecipeWorkstations;
...
public class DecompositionEmiRecipe implements EmiRecipe {
    private static final ResourceLocation BACKGROUND =
        ResourceLocation.fromNamespaceAndPath(FarmersDelight.MODID, "textures/gui/jei/decomposition.png");
    ...
    public @Nullable ResourceLocation getId() {
        return res("/decomposition/dummy");
    }
    ...
    private static ClientTooltipComponent createTooltip(@NotNull String suffix) {
        return ClientTooltipComponent.create(
            Component.translatable(FarmersDelight.MODID + ".jei.decomposition" + suffix).getVisualOrderText());
    }
}
