...
public abstract class AbstractMeltingEmiRecipe extends BasicEmiRecipe {
    ...
    public AbstractMeltingEmiRecipe(EmiRecipeCategory category, ResourceLocation id) {
    ...
    public void addWidgets(WidgetHolder widgets) {
        ...
        widgets.addText(Component.translatable(KEY_TEMPERATURE, getTemperature()), 56, 3, 0x808080, false)
                .horizontalAlign(TextWidget.Alignment.CENTER);

        widgets.addFillingArrow(56, 18, getTime() * 200)
                .tooltipText(List.of(Component.translatable(KEY_COOLING_TIME, getTime() / 5)));
